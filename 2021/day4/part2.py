...
def do_part2(input_file):
    ...
    return winning_boards[-1].winning_score


example_answer = do_part2("input.example.txt")
assert example_answer == 1924, f"calculated answer: {example_answer}"

print(f"[{datetime.now()}] Final score of winning board: {do_part2('input.txt')}")
